...
int main(int argc, char const *argv[])
{
    ...
    pocetDni += denDnes; // prida se soucet dnu
    
    if (mesicNarozeni  == 1 || mesicNarozeni  == 3 || mesicNarozeni  == 5 || mesicNarozeni  == 7 || mesicNarozeni  == 8 || mesicNarozeni  == 10 || mesicNarozeni  == 12)
    {
        pocetDni += 31 - denNarozeni;
    }
    else if (mesicNarozeni  == 4 || mesicNarozeni  == 6 || mesicNarozeni  == 9 || mesicNarozeni  == 11)
    {
        pocetDni += 30 - denNarozeni;
    }
    else if (mesicNarozeni  == 2)
    {
        pocetDni += 28 - denNarozeni;
    }
